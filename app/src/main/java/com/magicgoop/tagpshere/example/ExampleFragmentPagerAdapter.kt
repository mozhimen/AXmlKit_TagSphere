...
import com.magicgoop.tagpshere.example.showcase4.Showcase4Fragment
...
class ExampleFragmentPagerAdapter(
    ...
    private val tabTitles =
        arrayOf("Playground", "Showcase1", "Showcase2", "Showcase3", "Showcase4")
    ...
    override fun getItem(position: Int): Fragment {
        return when (position) {
            ...
            4 -> Showcase4Fragment.newInstance()
